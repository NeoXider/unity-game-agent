...
4. Reuse-first (по умолчанию): быстрый поиск готового решения под фичу (1–5 минут). Если не найдено или фича слишком маленькая и простая — писать код вручную.
...
- **Проверки только в самом конце** — после реализации всех блоков. Не проверять после каждой фичи.
- Тесты не требуются.
...
По желанию или кратко. `DEV_STATE.md` — контекст + текущая задача + ближайшие. `DEV_PLAN.md` — по желанию. `Docs/DEV_LOG/` — можно не вести; достаточно краткого списка «сделано / в работе» в DEV_STATE.
