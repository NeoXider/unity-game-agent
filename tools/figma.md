...
- **Макеты UI** — нарисовать экраны (меню, HUD, инвентарь) до реализации в Unity Canvas.
...
6. Реализация в Unity Canvas по макетам
```
...
- Это упростит перенос в Unity Canvas.
...
| **Unity Editor** | Прототип/Быстрый: UI прямо в Canvas |
